...
proc create_root_design { parentCell } {
  ...
  set FDMA_S_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:user:FDMA_rtl:1.0 FDMA_S_0 ]
  ...
  set ui_rstn [ create_bd_port -dir O -from 0 -to 0 -type rst ui_rstn ]
  ...
  set uiFDMA_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ikun_FDMA:1.0 uiFDMA_0 ]
  set_property -dict [ list \
   CONFIG.M_AXI_MAX_BURST_LEN {64} \
 ] $uiFDMA_0
  ...
  connect_bd_intf_net -intf_net uiFDMA_0_M_AXI [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins uiFDMA_0/M_AXI]

  # Create port connections
  connect_bd_net -net mig_7series_0_ui_clk1 [get_bd_ports ui_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins uiFDMA_0/M_AXI_ACLK]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_ports ui_rstn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins uiFDMA_0/M_AXI_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces uiFDMA_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
