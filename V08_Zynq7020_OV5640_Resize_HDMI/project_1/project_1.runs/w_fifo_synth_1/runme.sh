...
HD_PWD='F:/Video_scaler/V08_Zynq7020_OV5640_Resize_HDMI/project_1/project_1.runs/w_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log w_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source w_fifo.tcl
