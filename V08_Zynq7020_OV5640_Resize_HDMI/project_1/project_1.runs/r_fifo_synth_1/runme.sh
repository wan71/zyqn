...
HD_PWD='F:/Video_scaler/V08_Zynq7020_OV5640_Resize_HDMI/project_1/project_1.runs/r_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log r_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source r_fifo.tcl
