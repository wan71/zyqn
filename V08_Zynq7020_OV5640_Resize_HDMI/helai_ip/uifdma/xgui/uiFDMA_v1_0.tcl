...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "M_AXI_MAX_BURST_LEN" -parent ${Page_0}
...
proc update_PARAM_VALUE.M_AXI_MAX_BURST_LEN { PARAM_VALUE.M_AXI_MAX_BURST_LEN } {
	# Procedure called to update M_AXI_MAX_BURST_LEN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.M_AXI_MAX_BURST_LEN { PARAM_VALUE.M_AXI_MAX_BURST_LEN } {
	# Procedure called to validate M_AXI_MAX_BURST_LEN
	return true
}
...
proc update_MODELPARAM_VALUE.M_AXI_MAX_BURST_LEN { MODELPARAM_VALUE.M_AXI_MAX_BURST_LEN PARAM_VALUE.M_AXI_MAX_BURST_LEN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.M_AXI_MAX_BURST_LEN}] ${MODELPARAM_VALUE.M_AXI_MAX_BURST_LEN}
}
