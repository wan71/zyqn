...
#
# Generated by export_simulation on Sat Jun 04 21:08:10 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './add_28.sh' script.
...
./add_28.sh -noclean_files

For more information on the script, please type './add_28.sh -help'.
