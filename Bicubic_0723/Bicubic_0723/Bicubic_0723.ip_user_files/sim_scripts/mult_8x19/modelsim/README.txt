...
#
# Generated by export_simulation on Sat Jun 04 21:08:30 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mult_8x19.sh' script.

./mult_8x19.sh -reset_run
...
./mult_8x19.sh -noclean_files

For more information on the script, please type './mult_8x19.sh -help'.
