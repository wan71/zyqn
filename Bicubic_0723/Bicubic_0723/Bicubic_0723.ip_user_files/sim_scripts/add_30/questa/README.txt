...
#
# Generated by export_simulation on Sat Jun 04 21:07:51 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './add_30.sh' script.
...
./add_30.sh -noclean_files

For more information on the script, please type './add_30.sh -help'.
