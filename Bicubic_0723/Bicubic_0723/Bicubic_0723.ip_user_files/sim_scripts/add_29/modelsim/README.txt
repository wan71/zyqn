...
#
# Generated by export_simulation on Sat Jun 04 21:08:00 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './add_29.sh' script.
...
./add_29.sh -noclean_files

For more information on the script, please type './add_29.sh -help'.
