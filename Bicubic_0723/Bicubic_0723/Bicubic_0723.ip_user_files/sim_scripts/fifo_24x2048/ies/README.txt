...
#
# Generated by export_simulation on Sat Jul 23 16:29:49 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_24x2048.sh' script.

./fifo_24x2048.sh -reset_run
...
./fifo_24x2048.sh -noclean_files

For more information on the script, please type './fifo_24x2048.sh -help'.
