...
#
# Generated by export_simulation on Sat Jun 04 21:08:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './add_27.sh' script.
...
./add_27.sh -noclean_files

For more information on the script, please type './add_27.sh -help'.
