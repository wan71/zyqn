...
#
# Generated by export_simulation on Sat Jun 04 21:07:42 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_24x8192.sh' script.

./fifo_24x8192.sh -reset_run
...
./fifo_24x8192.sh -noclean_files

For more information on the script, please type './fifo_24x8192.sh -help'.
