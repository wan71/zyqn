...
#
# Generated by export_simulation on Sat Jun 04 21:07:33 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_25x32.sh' script.

./fifo_25x32.sh -reset_run
...
./fifo_25x32.sh -noclean_files

For more information on the script, please type './fifo_25x32.sh -help'.
