...
#
# Generated by export_simulation on Sat Jun 04 21:08:41 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_8x4096.sh' script.

./fifo_8x4096.sh -reset_run
...
./fifo_8x4096.sh -noclean_files

For more information on the script, please type './fifo_8x4096.sh -help'.
