...
HD_PWD='D:/FPGA/HDMI/bmp_hdmi1113/bmp_hdmi1113.runs/system_s02_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_s02_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_s02_mmu_0.tcl
