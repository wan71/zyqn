...
#
# Generated by export_simulation on Sun Oct 27 12:14:51 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_out_32.sh' script.

./fifo_out_32.sh -reset_run
...
./fifo_out_32.sh -noclean_files

For more information on the script, please type './fifo_out_32.sh -help'.
