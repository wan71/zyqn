...
HD_PWD='D:/github_project/zyqn/zyqn/bmp_hdmi_test8/bmp_hdmi_test8.runs/system_Bic_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Bic_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Bic_top_0_0.tcl
